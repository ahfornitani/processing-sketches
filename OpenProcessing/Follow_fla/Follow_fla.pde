...
void draw() {
  ...
  if (mouseX < (width/2)+3 && mouseX > (width/2)-3) {
    if (mouseY < height/2+10 && mouseY > height/2-10) { 
      ...
      /* the line above loaded a playful, "birthday" font.
          Changed to a default Windows font, as I can't recall the name of the original*/
      letra = loadFont("SegoeScript-Bold-48.vlw");
      textFont(letra);
